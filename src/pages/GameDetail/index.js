...
import {
  TABLE_TCB, TABLE_BACCARAT, TABLE_BACCARAT_FAST, TABLE_TCB_FAST,
} from '../../constants/api';
...
class GameDetail extends Component {
  ...
  initDetails = () => {
    ...
    getTableChipedAction({ tableId: id },
      (data) => {
  ...
  doChip = () => {
    ...
    const chipDetails = Object.keys(details[1]).filter(key => details[key] !== 0).map(item => ({
      amount: details[item],
      wagerType: item,
    }));
    doChipAction({
      ...
      tableId: this.id,
    }, this.chipSucc, this.chipErr);
  }

  cancelChip = () => {
    this.setState(state => ({
      details: [state.details[0], {
        1: 0,
        2: 0,
        3: 0,
        4: 0,
      ...
      >
        ...
        <div className={styles.content}>
          ...
          <div className={styles.chip}>
            <div className={styles.table} style={{ backgroundImage: `url(${backgroundImage})` }}>
              <div className={styles.line_1}>
                <div className={styles.xiandui} onClick={this.changeWagerType(5)}>
                  <span>1赔11</span>
                ...
                <div className={styles.zhuangdui} onClick={this.changeWagerType(4)}>
                  <span>1赔11</span>
              ...
              <div className={styles.line_2}>
                ...
                <div className={styles.zhuang} onClick={this.changeWagerType(1)}>
                  <span>1赔0.95</span>
            ...
            <div className={styles.btn}>
              <div className={`${styles.item} ${styles.cancel}`} onClick={this.cancelChip} />
              <div className={`${styles.item} ${styles.sure}`} onClick={this.doChip} />
            </div>
          </div>
        </div>
